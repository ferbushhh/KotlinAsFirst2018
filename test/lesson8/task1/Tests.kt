...
class Tests {
    ...
    fun lineBySegment() {
        ...
        assertApproxEquals(Line(0.10615342443547984, 0.0007670886403043322), lesson8.task1.lineBySegment(Segment(Point(0.852781203161011, 0.10680761456906862), Point(-632.0, 0.5922618892328279))))
    }
